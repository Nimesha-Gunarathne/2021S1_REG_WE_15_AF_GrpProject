...
import CheckNullValuesTest from '../../../../Test/checkNullValues';
import './payment.css'
...
class Payment extends Component {
    ...
    onSubmit(e) {
        ...
        if (test == "success") {
            axios.post('http://localhost:8070/payment/insertPayment', payment)
                .then(response => {

                    let email = {
                        email: this.state.payeeEmail
                    }
                    axios.put('http://localhost:8070/payment/changePaymentStatus', email)
                        .then(response => {
