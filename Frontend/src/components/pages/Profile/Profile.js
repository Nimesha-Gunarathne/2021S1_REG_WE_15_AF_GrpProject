...
const Profile = (props) => {
    ...
    useEffect(() => {
        const getProfile = async (email) => {
            try {
                const { data } = await axios.get(`http://localhost:8070/user/profile/${email}`);
                setProfile(data);
    ...
    return (
        ...
        <div className="">
            ...
            <div className="app-wrapper_IT19177106">
                ...
                {profile.data && profile.data.paper && profile.data.paper.state && profile.data.paper.state != "PENDING" && profile.data.paper.payment && profile.data.paper.payment != "DONE" &&
                    <Notifications />}
                ...
                <div className="form-container_IT19177106 row">
                    <div className="form_IT19177106 col">
                        <form className="form-wrapper" >
                            ...
                            {profile.data && profile.data.paper && profile.data.paper.payment && profile.data.paper.payment == "APPLICABLE" && profile.data.user && profile.data.user.role && profile.data.user.role == 'Researcher' &&
                                <lable className="approved_status">Your document has been Approved! Please make the neccessary payment</lable>
                            }
                            ...
                            <div>
                                ...
                                <Link to="/login" className="logout_key">Logout</Link>
